          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text('Are you sure you want to proceed with this transaction of Pera Out: $finalPera ?'),
                actions: [
                 TextButton(
                    onPressed: () {
                 ...
                 TextButton(
                    onPressed: () {
                      saveNewPeraOut(finalPera);
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('Pera Out Saved Successfully!')),
                      );
                      Navigator.of(context).pop();
                    },
